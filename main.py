...
def main(root):
    try:
        ...
        btn1_text = Button(background_box,command=lambda:student_details(root), text="Student Information", font=("Helvetica", 14, "bold"),bg="skyblue", fg='black',width=17)
        ...
        btn3_text = Button(background_box, text="Student Attendance",command=lambda:attendance_report(root), font=("Helvetica", 14, "bold"), bg="skyblue", fg='black',width=17)
        ...
        btn1_text = Button(background_box, text="Student Photos",command=lambda:open_image(root), font=("Helvetica", 14, "bold"), bg="skyblue", fg='black',width=17)
